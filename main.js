...
const translations = {
  tr: {
    ...
    feat3Title: "Gelişmiş Çoklu Çeviri Motoru",
    feat3Desc: "Google Translate (Varsayılan), MyMemory ve Lingva entegrasyonuyla kesintisiz, hızlı ve kaliteli çeviri deneyimi.",
  ...
  en: {
    ...
    feat3Title: "Multi-Engine Translation Support",
    feat3Desc: "Seamless translation powered by Google Translate (Default), MyMemory, and Lingva engines.",
