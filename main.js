...
const translations = {
  tr: {
    ...
    feat7Title: "HaYTooL Engine Arena (Benchmark)",
    feat7Desc: "6 çeviri motorunu aynı anda yarıştırın; milisaniye hızlarını ve çevirilerini canlı karşılaştırın.",
  ...
  en: {
    ...
    feat7Title: "HaYTooL Engine Arena (Benchmark)",
    feat7Desc: "Benchmark all 6 engines side-by-side in real-time; compare millisecond speeds and outputs.",
