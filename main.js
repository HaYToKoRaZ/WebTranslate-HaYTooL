...
const translations = {
  tr: {
    ...
    storeSubStore: "Resmi Mağazadan",
    storeNameStore: "Eklentiyi İndir",
    featHeading: "Neler Sunuyor?",
    featSub: "Hızlı, gizlilik odaklı ve modern web çevirmeni.",
    feat1Title: "Tek Tıkla Sayfa Çevirisi",
    feat1Desc: "Sağ tıklayıp 'Bu Sayfayı Çevir' demeniz yeterli. Sayfa düzenini bozmadan anında hedef dilinize çevirir.",
    ...
    feat3Title: "Gelişmiş Çoklu Dil Motoru",
    feat3Desc: "Google Translate, MyMemory ve Lingva entegrasyonlarıyla eksiksiz ve akıcı yerel sayfa çevirisi sağlar.",
  ...
  en: {
    ...
    storeSubStore: "Official Store",
    storeNameStore: "Get Extension",
    featHeading: "What It Offers",
    featSub: "Fast, privacy-focused and modern browser translator.",
    feat1Title: "One-Click Full Page Translation",
    feat1Desc: "Simply right-click and choose 'Translate this page'. Translates seamlessly into your target language without breaking the layout.",
    ...
    feat3Title: "Advanced Multi-Engine",
    feat3Desc: "Provides fast and reliable page translation powered by Google, MyMemory and Lingva engines.",
